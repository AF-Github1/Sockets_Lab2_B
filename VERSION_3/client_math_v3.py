...
def execute(connection, op_sinal, dicionario_operandos):
    """
    Envio de dicionário para realizar operação de adição
    """
    send_str(connection, op_sinal)
    send_object(connection, dicionario_operandos) # Utilização de função adicionada previamente para conseguir enviar objecto dicionario
